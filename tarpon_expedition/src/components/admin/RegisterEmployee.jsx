                ...
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', height: '80vh',}}>
                    <div style={{float: 'right', width: '50%', height:'100%', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'auto'}}>
                        <div style={{backgroundColor: 'transparent', height:'80%', width:'80%', display: 'flex', flexDirection: 'column', overflow: 'auto', alignItems: 'center', justifyContent: 'center', borderRadius: '10px',backdropFilter: 'blur(15px)',border: '2px solid rgba(255,255,255,.5)',boxShadow: '0 0 30px rgba(0,0,0,.5)'}}>
                            <label style={{fontFamily: 'lato', fontSize: '30px', fontWeight:'bold', marginBottom:'20px', marginTop:'20px',color:'black'}}>Sign Up</label>
                            <div style={{height:'7%', width:'100%', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'auto'}}>
                                <label style={{fontFamily: 'lato', fontSize: '20px', position: 'relative', left: '-117px',color:'black'}}>First Name</label>
                                <label style={{fontFamily: 'lato', fontSize: '20px', position: 'relative', left: '10px',color:'black'}}>Last Name</label>
                            </div>
                            ...
                            <label style={{fontFamily: 'lato', fontSize: '20px', position: 'relative', left: '-147px',color:'black'}}>Email Address</label>
                            <input type="text" id="Email" style={{height:'5%', borderRadius: '5px', width:'67.5%', marginBottom:'20px', position: 'relative'}}
                                onChange={(event) =>{
                                    setEmail(event.target.value);
                            }}/>
                            <label style={{fontFamily: 'lato', fontSize: '20px', position: 'relative', left: '-153px',color:'black'}}>Date of Birth</label>
                            ...
                            <div style={{height:'7%', width:'100%', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'auto'}}>
                                <label style={{fontFamily: 'lato', fontSize: '20px', position: 'relative', left: '-93px',color:'black'}}>Password</label>
                                <label style={{fontFamily: 'lato', fontSize: '20px', position: 'relative',left: '49px',color:'black'}}>Confirm Password</label>
                            </div>
                            <div style={{height:'7%', width:'100%', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'auto'}}>
